//gestiona los parametros de configuracion del buscaminas como el tamaño del tablero, la cantidad de minas, vidas y el modo de depuracion
#include <iostream>
#include <unistd.h>
#include "Config.h"
using namespace std;

//constructor que inicializa los ajustes del juego
Config::Config(int filasTablero, int columnasTablero, int minasTablero, bool modoDesarrolladorTablero, int vidasTablero)
{
//filasTablero numero de filas
    this->filasTablero = filasTablero;

//columnasTablero numero de columnas
    this->columnasTablero = columnasTablero;

//minasTablero cantidad total de minas a colocar
    this->minasTablero = minasTablero;

//modoDesarrolloTablero activa/desactiva la visibilidad de minas
    this->modoDesarrolladorTablero = modoDesarrolladorTablero;

//vidasTablero cantidad de intentos permitidos
    this->vidasTablero = vidasTablero;
}

//despliega un menu interactivo en consola para modificar los ajustes
...
//Si el usuariono quiere salir, pedimos el nuevo valor
        if (opciones!=6)
        {
