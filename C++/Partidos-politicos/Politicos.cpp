...
void llenarMatriz(float matriz[NUMERO_PARTIDOS][NUMERO_REGIONES + 1]);
void imprimirMatrizLinea();
float imprimirMatriz(float matriz[NUMERO_PARTIDOS][NUMERO_REGIONES + 1], char partidos[NUMERO_PARTIDOS][MAXIMA_LONGITUD_CADENA], string nombreEleccion);
int main()
{
    srand(getpid());
    llamaCiclo();
